const datasetConfig = {
  datasetName: "HIED",
  contactEmail: "ceshiyong@hotmail.com",
...
const translations = {
  zh: {
    ...
    "access.card.text": "HIED 预处理 EEG 数据需要通过申请审核获取，请下载 Word 申请表，填写研究用途、申请人信息和数据使用承诺后发送至指定邮箱。",
  ...
  en: {
    ...
    "access.card.text": "Access to the preprocessed HIED EEG data requires review. Download the Word application form, complete the research purpose, applicant information, and data-use commitment, then email it to the dataset contact address.",
    ...
    "access.downloadForm": "Download Application Form",
