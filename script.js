...
const translations = {
  zh: {
    ...
    "overview.p2": "数据包提供预处理后的 EEG 时序信号，不包含已提取特征。申请者提交 Word 申请表并经审核后获取数据，可根据研究设计开展特征提取、建模与验证。",
    ...
    "access.card.text": "HIED 预处理 EEG 数据需要通过申请审核获取。请按使用语言下载中文或英文 Word 申请表，填写研究计划、申请人信息和数据使用承诺后发送至指定邮箱。",
    "access.req1": "申请用途应为学术研究或非商业研究。",
    "access.req2": "申请人需说明研究主题、单位和预期数据使用方式。",
    "access.req3": "数据不得用于识别被试身份或超出审核范围的二次分发。",
    "access.req4": "论文或成果中使用 HIED 时，请引用关联论文。",
    "access.downloadFormEn": "下载英文申请表",
    "access.downloadFormCn": "下载中文申请表",
    "form.title": "生成申请邮件",
    "form.name": "姓名",
    ...
    "form.purpose": "研究用途",
    "form.purposePlaceholder": "简要说明研究主题和数据使用方式",
    "form.submit": "打开邮件客户端",
    "form.status": "邮件窗口已打开，请附上已填写的 Word 申请表后发送。",
    "section.citation": "引用",
    "citation.title": "关联论文",
    ...
    "footer.access": "HIED 预处理 EEG 数据需提交申请表审核。",
  },
  en: {
    languageCode: "en",
    ...
    "overview.p2": "The data package provides preprocessed EEG time-series signals and does not include extracted features. Applicants submit the Word application form for review and can perform feature extraction, modeling, and validation according to their research design after approval.",
    ...
    "access.card.text": "Access to the preprocessed HIED EEG data requires review. Download the English or Chinese Word request form, complete the research plan, applicant information, and data-use commitments, then email it to the dataset contact address.",
    "access.req1": "The intended use should be academic or non-commercial research.",
    "access.req2": "Applicants should describe the research topic, affiliation, and expected data-use plan.",
    "access.req3": "The data must not be used to identify participants or redistributed beyond the approved scope.",
    "access.req4": "Please cite the associated paper when HIED is used in publications or research outputs.",
    "access.downloadFormEn": "Download English Form",
    "access.downloadFormCn": "Download Chinese Form",
    ...
    "form.purpose": "Research purpose",
    "form.purposePlaceholder": "Briefly describe your study and intended use of the data",
    "form.submit": "Open Email Client",
    "form.status": "Email draft opened. Please attach the completed Word application form before sending.",
...
const buildApplicationEmail = (form) => {
  ...
  const purpose = getFormValue(form, "purpose");
  ...
  if (currentLanguage === "zh") {
    return {
      ...
      body: [
        ...
        `研究用途：${purpose || "请填写"}`,
        "",
        "我将随邮件附上已填写的 Word 申请表，并承诺仅在审核通过范围内用于学术或非商业研究。",
        "",
        "谢谢！",
      ].join("\n"),
    };
  ...
  return {
    subject,
      ...
      `Research purpose: ${purpose || "Please complete"}`,
      "",
      "I will attach the completed Word application form to this email and will use the data only for approved academic or non-commercial research.",
      "",
      "Thank you.",
    ].join("\n"),
  };
